# Generated by Django 3.2.13 on 2024-09-10 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rack', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.bookrack')),
            ],
            options={
                'db_table': 'book_shelf',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.reader')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.bookcard')),
                ('book_shelf_new', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_shelf_new', to='admin.bookshelf')),
                ('book_shelf_old', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_shelf_old', to='admin.bookshelf')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('librarian', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.librarian')),
            ],
            options={
                'db_table': 'book_room',
            },
        ...
        migrations.AddField(
            model_name='bookrack',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.bookroom'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.bookcard')),
                ('reader_card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.readercard')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='bookcard',
            name='book_shelf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.bookshelf'),
        ),
        migrations.AddField(
            model_name='bookcard',
            name='publication_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin.publicationtype'),
        ),
    ]
